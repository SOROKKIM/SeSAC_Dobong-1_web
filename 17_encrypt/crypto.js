...
console.log("3rd hashing", createHashPW("1234")); //전부 다 똑같은 값이 나옴
...
// const str = "hello!";
// const buffer = Buffer.from(str); // 이진데이터가 담겨있음 콘솔창에는 16진수로 표현된다.
// console.log(buffer);
...
const iv = crypto.randomBytes(16); //> 서로 다른 문자열? 만듬 inintial vector
