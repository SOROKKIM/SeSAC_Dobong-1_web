...
export default function Chatting3() {
  ...
  const [nickname, setNickname] = useState(null); // 내 닉네임 관리하는 state
  ...
  const userOptions = useMemo(() => {
    ...
    //userList = {socket.id:닉네임1, socket.id:닉네임2}
  ...
  return (
    <>
      ...
      {/* // 닉네임이 null이면 닉네임 입력창 // 닉네임이 있으면 채팅창 */}
      {!nickname ? (
